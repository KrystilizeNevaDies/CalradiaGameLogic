package net.calradia.game.gamedata.loottables;

import net.calradia.game.gamedata.conditions.AlternativesCondition;
...
import net.calradia.game.gamedata.conditions.InvertedCondition;
