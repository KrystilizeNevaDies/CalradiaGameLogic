...
import net.calradia.game.blockentity.BlockEntity;
import net.calradia.game.blockentity.NetherPortalBlockEntity;
import net.calradia.game.data.NetherPortalList;
import net.calradia.game.dimensions.VanillaDimensionTypes;
import net.calradia.game.event.entity.EntityEnterNetherPortalEvent;
import net.calradia.game.event.entity.NetherPortalTeleportEvent;
import net.calradia.game.event.entity.NetherPortalUpdateEvent;
