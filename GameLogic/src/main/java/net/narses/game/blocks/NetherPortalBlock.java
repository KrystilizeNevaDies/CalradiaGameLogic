package net.narses.game.blocks;

import net.narses.game.blockentity.BlockEntity;
import net.narses.game.blockentity.NetherPortalBlockEntity;
import net.narses.game.data.NetherPortalList;
import net.narses.game.dimensions.VanillaDimensionTypes;
import net.narses.game.event.entity.EntityEnterNetherPortalEvent;
import net.narses.game.event.entity.NetherPortalTeleportEvent;
import net.narses.game.event.entity.NetherPortalUpdateEvent;
