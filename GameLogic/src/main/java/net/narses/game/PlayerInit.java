...
import net.narses.game.anvil.AnvilChunkLoader;
...
import net.narses.game.blocks.NetherPortalBlock;
import net.narses.game.blocks.VanillaBlocks;
import net.narses.game.dimensions.VanillaDimensionTypes;
import net.narses.game.generation.VanillaTestGenerator;
import net.narses.game.instance.VanillaExplosion;
    ...
    public static void init(ServerProperties properties) {
        ...
        connectionManager.addPlayerInitialization(player -> {
            ...
            player.addEventCallback(PlayerBlockBreakEvent.class, event -> {
                if(event.getPlayer().getGameMode() == GameMode.SURVIVAL) VanillaBlocks.dropOnBreak(player.getInstance(), event.getBlockPosition());
            });
            ...
            player.addEventCallback(ItemDropEvent.class, event -> {
                player.sendMessage("You cannot drop items!");
