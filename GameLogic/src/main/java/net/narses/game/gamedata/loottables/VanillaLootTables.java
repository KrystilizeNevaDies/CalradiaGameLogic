package net.narses.game.gamedata.loottables;

import net.narses.game.gamedata.conditions.AlternativesCondition;
...
import net.narses.game.gamedata.conditions.InvertedCondition;
